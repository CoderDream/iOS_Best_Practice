...
// "6560fba37fc52d7e16bd3399ae4b89ca" // APIKey
...
class ViewController: UIViewController, MAMapViewDelegate, PlaceAroundTableViewDeleagate {
    ...
    override func viewDidLoad() {
        ...
        AMapServices.shared().apiKey = "6560fba37fc52d7e16bd3399ae4b89ca"
    ...
    func initTableView() {
        self.tableView = PlaceAroundTableView(frame: CGRect(x: 0, y: self.view.bounds.height / 2.0,
    ...
    func initLocationButton() {
        ...
        self.locationBtn = UIButton(frame: CGRect(x: CGFloat(self.mapView.bounds.width - 40), y: CGFloat(self.mapView.bounds.height - 50),
                                                  width: CGFloat(32), height: CGFloat(32)))
    ...
    func initSearchTypeView() {        
        ...
        self.searchTypeSegment.frame = CGRect(x: CGFloat(10), y: CGFloat(self.mapView.bounds.height - 50),
                                              width: CGFloat(self.mapView.bounds.width - 80), height: CGFloat(32))
    ...
    @objc func actionLocation() {
        if self.mapView.userTrackingMode == .follow {
            ...
            DispatchQueue.main.asyncAfter(deadline: DispatchTime.now() + Double(0.5 * Double(NSEC_PER_SEC)) / Double(NSEC_PER_SEC),
                                          execute: {() -> Void in
    ...
    func didTableViewSelectedChanged(selectedPOI: AMapPOI!) {
        ...
        let location = CLLocationCoordinate2D(latitude: CLLocationDegrees(selectedPOI.location.latitude),
                                              longitude: CLLocationDegrees(selectedPOI.location.longitude))
