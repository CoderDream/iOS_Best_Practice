...
class ResultView: UIView {
    ...
    func drawString(string : String, inRect: CGRect, fontSize: CGFloat, color: UIColor) {
        ...
        string.draw(in: inRect, withAttributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: fontSize), NSAttributedString.Key.foregroundColor: usedColor, NSAttributedString.Key.paragraphStyle: style])
    }
